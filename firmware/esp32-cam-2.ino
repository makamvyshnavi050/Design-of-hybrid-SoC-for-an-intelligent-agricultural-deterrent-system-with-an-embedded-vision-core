...
// --- UPDATED STATIC IP SETTINGS FOR CAM 2 ---
IPAddress local_IP(172, 18, 170, 101); // Fixed IP for Board 2
...
void setup()
{
  ...
  server.begin();
  Serial.println("CAM 2 Ready at 172.18.170.101");
}
