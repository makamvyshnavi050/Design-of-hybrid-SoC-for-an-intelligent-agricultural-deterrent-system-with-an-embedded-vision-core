...
# --- 1. SETTINGS ---
url_phone = 'http://10.198.60.103:8080/video'
url_esp32_signal = 'http://172.18.170.101/signal?state='
whT = 416
confThreshold = 0.7
nmsThreshold = 0.3 
...
cv2.putText(im, label.upper(), (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.6, 
color, 2)
